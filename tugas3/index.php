<?php
	...
	if(isset($_GET['hal'])){
		...
		if($_GET['hal'] == "edit"){
			...
			$tampil = mysqli_query($koneksi,"SELECT * FROM tbl_011 WHERE id_buku= '$_GET[id]' ");
			...
			//menghapus
			$hapus = mysqli_query($koneksi, "DELETE FROM tbl_011 WHERE id_buku = '$_GET[id]'");
			if($hapus)
			{
				echo "<script>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    <table class="table table-bordered table-striped">
	    	...
	    	<?php
	    		$tampil =mysqli_query($koneksi, "SELECT *from tbl_011 order by id_buku");
	    	...
	    	<tr>
	    		...
	    		<td>
	    			<a href="index.php?hal=edit&id=<?=$data['id_buku']?>" class="btn btn-success"> Edit</a>
